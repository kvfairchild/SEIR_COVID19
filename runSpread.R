...
if(!require('argparse')) install.packages('argparse'); library(argparse)
...
parser$add_argument("--InitR")
parser$add_argument("--InitD")
...
InitR=strtoi(args$InitR)
InitD=strtoi(args$InitD)
yscale="linear"
...
write.csv(out.df,file=args$saveModel)
